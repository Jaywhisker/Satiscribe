...
function FullTranscript() {
    return (
        <>
            ...
            <div className={`${contentblock.largeBlockContainernohover} ${flexi.flexcolumnSmolGap} ${flexi.alignstart}`}>
                <div className={flexi.padding50vert}>
                    ...
                    <div className={`${contentblock.topContainer}`}> 
                        <ul>
                            ...
                            <li> <p style={{color: `var(--Final_White)`}}>Sentence 3</p></li>
                            <li> <p style={{color: `var(--Final_White)`}}>Sentence 1</p></li>
                            <li> <p style={{color: `var(--Final_White)`}}>Sentence 2</p></li>
                            <li> <p style={{color: `var(--Final_White)`}}>Sentence 3</p></li>
                            <li> <p style={{color: `var(--Final_White)`}}>Sentence 1</p></li>
            ...
            <div className={`${contentblock.largeBlockContainernohover} ${flexi.flexcolumnSmolGap} ${flexi.alignstart}`}>
                <div className={flexi.padding50vert}>
                    <div className={`${contentblock.topContainer} ${flexi.flexrowSmolGap} ${flexi.alignSpacebetween}`}> 
                        <h5>Full Transcript</h5>
